<template>
    <div>
      <!--搜索表单-->
     <div>
      <el-input style="width: 200px"  placeholder="请输入管理员id" v-model="params.operateUser"></el-input>
  ...
  export default {
    ...
    methods:{
      ...
      /*del(id) {
        request.delete('/operateLog/delete/' + id).then(res => {
          if (res.code === '200'){
